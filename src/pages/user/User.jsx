                ...
                <div className="userShow">
                    ...
                    <div className="userShowBottom">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">+90 555 555 55 55</span>                        
                        </div>
                        <div className="userShowInfo">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">Bursa | Turkey</span>                        
                        </div>
                    </div>
                </div>
                <div className="userUpdate">
                    ...
                    <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                <label>Phone</label>
                                <input type="text" placeholder="+90 555 555 55 55" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                                <input type="text" placeholder="Bursa | Turkey" className="userUpdateInput" />
                            </div>
                        </div>
